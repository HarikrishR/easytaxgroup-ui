...
const Services = () => {
  ...
  const [selectedService, setSelectedService] = useState<'taxPrep' | 'salesTax' | 'payroll' | 'businessRegistration' | 'bookkeeping' | 'fmcsa' | 'form8843' | null>(null);

  const serviceContent = {
    taxPrep: {
      title: "Tax Preparation & Filing",
      icon: <AiOutlineFileDone />,
      description: "We provide complete tax preparation and filing services for individuals, businesses, and self-employed professionals.",
      content: (
    ...
    salesTax: {
      ...
      icon: <LiaSalesforce />,
      description: "Sales tax compliance is critical and often complicated for product and service-based businesses.",
      content: (
        <div className="serviceContent">
    ...
    payroll: {
      ...
      icon: <GoCreditCard />,
      description: "Managing payroll can be time-consuming and risky if done incorrectly.",
      content: (
        <div className="serviceContent">
    ...
    bookkeeping: {
      ...
      icon: <SlBookOpen />,
      description: "Accurate bookkeeping is the foundation of any successful business.",
      content: (
        <div className="serviceContent">
    ...
    form8843: {
      title: "Tax Guide For Indian Students",
      icon: <FaWpforms />,
      description: "Complete tax guide for Indian students on F1 visa.",
      content: (
        <div className="serviceContent">
          ...
          <Link target="_blank" to="/taxfilling" className='btnPrimary'>Apply Now</Link>
        </div>
      )
    }
  };

  const openModal = (service: 'taxPrep' | 'salesTax' | 'payroll' | 'businessRegistration' | 'bookkeeping' | 'fmcsa' | 'form8843') => {
  ...
  return (
    <>
      ...
      <section className="serIntro">
        <div className="container">
          <div className="row justify-content-center align-items-center">
            <div className="col-md-6 col-lg-4 mb-3" onClick={() => openModal('taxPrep')} style={{ cursor: 'pointer' }}>
              <div className="serInfoBox overflow-hidden shadow">
                <img src={service1} className='w-100 serInfoImg' />
                <div className="overlay">
                  <div className="head d-flex align-items-center">
                    <div className="headtitle"><AiOutlineFileDone /> </div>
                    <div>
            ...
            <div className="col-md-6 col-lg-4 mb-3" onClick={() => openModal('salesTax')} style={{ cursor: 'pointer' }}>
              <div className="serInfoBox overflow-hidden shadow">
                <img src={service2} className='w-100 serInfoImg' />
                <div className="overlay">
                  <div className="head d-flex align-items-center">
                    <div className="headtitle"><LiaSalesforce /> </div>
                    <div>
            ...
            <div className="col-md-6 col-lg-4 mb-3" onClick={() => openModal('payroll')} style={{ cursor: 'pointer' }}>
              <div className="serInfoBox overflow-hidden shadow">
                <img src={service3} className='w-100 serInfoImg' />
                <div className="overlay">
                  <div className="head d-flex align-items-center">
                    <div className="headtitle"><GoCreditCard /> </div>
                    <div>
            ...
            <div className="col-md-6 col-lg-4 mb-3" onClick={() => openModal('businessRegistration')} style={{ cursor: 'pointer' }}>
              <div className="serInfoBox overflow-hidden shadow">
                <img src={service4} className='w-100 serInfoImg' />
                <div className="overlay">
                  <div className="head d-flex align-items-center">
                    <div className="headtitle"><MdAppRegistration /> </div>
                    <div>
            ...
            <div className="col-md-6 col-lg-4 mb-3" onClick={() => openModal('bookkeeping')} style={{ cursor: 'pointer' }}>
              <div className="serInfoBox overflow-hidden shadow">
                <img src={service5} className='w-100 serInfoImg' />
                <div className="overlay">
                  <div className="head d-flex align-items-center">
                    <div className="headtitle"><SlBookOpen /> </div>
                    <div>
            ...
            <div className="col-md-6 col-lg-4 mb-3" onClick={() => openModal('fmcsa')} style={{ cursor: 'pointer' }}>
              <div className="serInfoBox overflow-hidden shadow">
                <img src={service4} className='w-100 serInfoImg' />
                <div className="overlay">
                  <div className="head d-flex align-items-center">
                    <div className="headtitle"><GrCompliance /> </div>
                    <div>
                      <h3 className="m-0">FMCSA Compliance</h3>
                    </div>
                  </div>
                  <p>We offer end-to-end compliance support for trucking and logistics businesses regulated by FMCSA. Our services include:</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-3" onClick={() => openModal('form8843')} style={{ cursor: 'pointer' }}>
              <div className="serInfoBox overflow-hidden shadow">
                <img src={service5} className='w-100 serInfoImg' />
                <div className="overlay">
                  <div className="head d-flex align-items-center">
                    <div className="headtitle"><FaWpforms /> </div>
                    <div>
                      <h3 className="m-0">Tax Guide For Indian Students</h3>
                    </div>
                  </div>
                  <p>Complete tax guide for Indian students on F1 visa, including Form 8843 filing requirements and deadlines:</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="modal-content">
              <div className="modal-header">
                <div className="d-flex align-items-center gap-2">
                  <span className="modal-icon">{serviceContent[selectedService].icon}</span>
                  <h5 className="modal-title mb-0">{serviceContent[selectedService].title}</h5>
                </div>
                <button type="button" className="btn-close" onClick={closeModal}></button>
              </div>
              <div className="modal-body">
                {serviceContent[selectedService].content}
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="row">
                <div className="col-sm-4 mb-4 mb-sm-0">
                  <div className="nav shadow align-items-start nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button className="nav-link" id="8843Filling-tab" data-bs-toggle="pill" data-bs-target="#8843Filling" type="button" role="tab" aria-controls="8843Filling" aria-selected="false"><FaWpforms /> Tax Guide For Indian Students</button>
                  </div>
                </div>
